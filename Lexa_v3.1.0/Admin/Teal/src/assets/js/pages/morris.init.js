...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#ccc', '#3eb7ba', '#36508b']);
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#3eb7ba', '#f0f1f4']);
