...
$(document).ready(function() {
    ...
    $(document).on('click', ".buttons-delete", function() {
        var rows = table5.rows('.selected');
        rows.remove().draw();
    });

    $(document).on("click", "#datatable-buttons5 th.select-checkbox", function() {
        if ($("#datatable-buttons5 th.select-checkbox").hasClass("selected")) {
            table5.rows().deselect();
            $("#datatable-buttons5 th.select-checkbox").removeClass("selected");
        } else {
            table5.rows().select();
            $("#datatable-buttons5 th.select-checkbox").addClass("selected");
        }
    }).on("select deselect", function() {
        ("Some selection or deselection going on")
        if (table5.rows({
    ...
    $(document).on('click', ".buttons-delete", function() {
        var rows = table6.rows('.selected');
        rows.remove().draw();
    });

    $(document).on("click", "#datatable-buttons6 th.select-checkbox", function() {
        if ($("#datatable-buttons6 th.select-checkbox").hasClass("selected")) {
            table6.rows().deselect();
            $("#datatable-buttons6 th.select-checkbox").removeClass("selected");
        } else {
            table6.rows().select();
            $("#datatable-buttons6 th.select-checkbox").addClass("selected");
        }
    }).on("select deselect", function() {
        ("Some selection or deselection going on")
        if (table6.rows({
                selected: true
            }).count() !== table6.rows().count()) {
            $("#datatable-buttons6 th.select-checkbox").removeClass("selected");
        } else {
            $("#datatable-buttons6 th.select-checkbox").addClass("selected");
        }
